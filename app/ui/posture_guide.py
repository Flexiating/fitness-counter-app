...
class PostureGuide(QFrame):
    ...
    def _card() -> tuple[QFrame, QVBoxLayout, QLabel]:
        ...
        layout = QVBoxLayout(card); heading = QLabel(); heading.setObjectName("sectionLabel")
    ...
    def retranslate(self) -> None:
        self.title.setText(tr("guide.title").upper()); self.subtitle.setText(tr("guide.subtitle"))
